...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase bg-success" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${student.fname} ${student.lname} </a>
     
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${student.regNo} </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="AcceptedComplaints.jsp">Accepted</a>
            <a class="collapse-item" href="RejectedComplaints.jsp">Rejected</a>
            <a class="collapse-item" href="DoneComplaints.jsp">Done</a>
            <a class="collapse-item" href="Complaints.jsp">Submitted</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${student.fname}  ${student.lname}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${student.roomNumber}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${student.phoneNumber}</p>
        </div>
      </div>
