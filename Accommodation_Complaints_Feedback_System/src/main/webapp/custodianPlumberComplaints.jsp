...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Complaints sent to Plumber</h2>
     ...
     <tr>
			...
			<tr>
			<td><b>Plumbers Complaint Id</b></td>
			...
			<td><%out.println(resultSet.getString("pcid")); %></td>
