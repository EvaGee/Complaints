...
<html>
<head>
<title>Mason Registration</title>
<meta charset="utf-8">
...
<div class="container-fluid bg">
		<div class="row">
			...
			<div class="col-md-2 col-sm-4 col-xs-12"></div>
				<!-- Form Start -->
            <form class="form-container" method="post" action="/masonRegister" name="mason_registration_form" id="mason_registration_form" onsubmit="return validateForm()">
                <h1>Mason Registration Form</h1>
            ...
            <script>
                function validateForm()                                    
                    { 
                		var staffNo = document.forms["mason_registration_form"]["staffNo"];
                        var fname = document.forms["mason_registration_form"]["fname"];               
                        var lname = document.forms["mason_registration_form"]["lname"];
                        var uname = document.forms["mason_registration_form"]["uname"];
                        var phoneNumber = document.forms["mason_registration_form"]["phoneNumber"];
                        var password = document.forms["mason_registration_form"]["password"];
                        var confirmPassword = document.forms["mason_registration_form"]["confirmPassword"];
