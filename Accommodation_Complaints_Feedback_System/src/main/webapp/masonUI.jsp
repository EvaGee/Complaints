...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase bg-success" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${mason.fname} ${mason.lname} </a>
     
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${mason.staffNo} </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${mason.fname}  ${mason.lname}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${mason.phoneNumber}</p>
        </div>
      </div>
