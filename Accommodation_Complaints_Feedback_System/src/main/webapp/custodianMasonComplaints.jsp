...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Complaints sent to Mason</h2>
     ...
     <tr>
			...
			<td><%out.println(resultSet.getString("mcid")); %></td>
