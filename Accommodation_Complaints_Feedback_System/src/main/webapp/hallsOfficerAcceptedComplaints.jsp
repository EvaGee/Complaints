...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase bg-success" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${hallsOfficer.fname} ${hallsOfficer.lname} </a>
     
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${hallsOfficer.staffNo} </a>
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="hallsOfficerUI.jsp">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="hallsOfficerUI.jsp">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	 <a class="collapse-item" href="hallsOfficerView.jsp">View Complaints</a>
            <a class="collapse-item" href="hallsOfficerAcceptedComplaints.jsp">Accepted</a>
            <a class="collapse-item" href="hallsOfficerRejectedComplaints.jsp">Rejected</a>
            <a class="collapse-item" href="hallsOfficerDoneComplaints.jsp">Done</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Accepted complaints</h2>
