      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="masonDoneComplaints.jsp">Done Complaints</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${plumber.fname}  ${plumber.lname}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${plumber.staffNo}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${plumber.phoneNumber}</p>
        </div>
      </div>
