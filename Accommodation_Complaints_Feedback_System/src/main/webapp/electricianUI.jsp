...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase bg-success" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${electrician.fname} ${electrician.lname} </a>
     
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${electrician.staffNo} </a>
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="electricianUI.jsp">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="electricianUI.jsp">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	 <a class="collapse-item" href="electricianView.jsp">View Complaints</a>
            <a class="collapse-item" href="electricianDoneComplaints.jsp">Done Complaints</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${electrician.fname}  ${electrician.lname}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${electrician.staffNo}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${electrician.phoneNumber}</p>
        </div>
      </div>
