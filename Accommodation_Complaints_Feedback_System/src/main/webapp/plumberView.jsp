...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase bg-success" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${plumber.fname} ${plumber.lname} </a>
     
      <a class="navbar-brand js-scroll-trigger" href="#page-top">${plumber.staffNo} </a>
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="plumberUI.jsp">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="plumberUI.jsp">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	 <a class="collapse-item" href="plumberView.jsp">View Complaints</a>
            <a class="collapse-item" href="plumberDoneComplaints.jsp">Done Complaints</a>
          </div>
        </div>
      </li>
    ...
    <tr>
			...
			String sql ="SELECT * FROM plumbers_complaints";
		    ...
		    <td>
		    <form id="done_complaint_form" name="done_complaint_form" method="post" enctype="form-data" action="/plumbersDoneComplaint">

		    <button type="submit" class="btn btn-success">Done</button>

		    <input type="hidden" id="ecid" name="ecid" value="<%=resultSet.getString("pcid")%>">
